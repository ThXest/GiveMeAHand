...
import { doc, getDoc, collection, getDocs, query, orderBy, limit, setDoc, addDoc, where, or, and, onSnapshot } from 'firebase/firestore';
...
const Chat = ({ navigation, route }) => {
  ...
  const getChats = () => {
    ...
    const unsubQuery = onSnapshot(query1, (querySnapshot) => {
      const newMessages = [];
